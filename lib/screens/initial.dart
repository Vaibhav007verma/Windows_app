...
import 'package:abc/additional_screens/valid/home_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("PolyMax"),),
      body: Column(
        children: [
          Container(
          ...
          Container(
            width: double.infinity,
            height: MediaQuery.of(context).size.height * 0.8, color: Colors.amberAccent,
            child: HomePage(),
          ),
        ],
      )
